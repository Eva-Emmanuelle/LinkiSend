...
<head>
  ...
  <!-- Favicon pour éviter le 404 en console -->
  ...
  <!-- ✅ WalletConnect provider local (hébergé dans /assets/vendor/wc/) -->
  <script defer src="/assets/vendor/wc/ethereum-provider.bundle.min.js"></script>
  <!-- ✅ QR Modal requis par le provider -->
  <script defer src="https://cdn.jsdelivr.net/npm/@reown/appkit@1/dist/index.umd.js"></script>
</head>
...
<body>
  ...
  document.addEventListener('DOMContentLoaded', ()=> {
    ...
    // ====== Utilitaires chargement scripts UMD ======
    ...
    // ====== WalletConnect helpers (corrigé) ======
    function getWcGlobal() {
      // 1) Bundle local UMD expose: window['@walletconnect/ethereum-provider'].EthereumProvider
      ...
      // 2) Autres noms globaux possibles
      return (
    ...
    async function loadWalletConnectProvider() {
      let EP = getWcGlobal(); // devrait être dispo via le bundle local
      if (EP) return EP;
      // Fallback CDN si nécessaire
      const umd = [
